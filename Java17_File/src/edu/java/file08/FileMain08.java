...
//		(예) /Users/dahyun/Desktop/JAVA_CODES/Java17_File
// - 상대 경로: 현재 작업 디렉토리를 기준으로 파일(폴더)의 위치를 표시
//		(예) temp/test.txt
//		. : 현재 디렉토리(폴더)
//		.. : 상위 디렉토리(폴더)

// 파일 구분자(file separator) -운양체제(OS)마다 다르게 사용
//		MS Windows	- \ 사용
//		Unix, Linux, macOS, ... - / 사용
// 자바에는 File.separator 변수 사용

public class FileMain08 {
	public static final String TEST_DIR1 = "//test1"; //절대 경로
	public static final String TEST_DIR2 = "test2"; //상대 경로
	public static final String TEST_DIR3 = "C:" + File.separator + "Study" + File.separator + "test";
