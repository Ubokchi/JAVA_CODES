...
<body>
	<%
		// form input name 이름으로 parameter 데이터 저장
	...
	<jsp:useBean id="member" class="web.ch13.bean.MemberBean"></jsp:useBean>
	<%-- request로 전송된 모든 form data를 MemberBean 객체의 각 프로퍼티에 적용 --%>
